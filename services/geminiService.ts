      ...
      if (currentNode.type === NodeType.ROOT) {
           ...
           taskPrompt = `
             ...
             **核心要求（事件广度）：**
             ...
             8. **【主角成长关键态】(IMPORTANT)**：在每个分卷的Summary中，必须明确标记主角在该卷结束时的**关键状态变化**。
                - **境界/等级**：本卷开始时主角是什么境界，本卷结束时主角达到了什么境界？
                - **特殊物品**：本卷中获得了什么核心金手指组件或神器，根据不同的阶段设计，根据当前分卷的剧情设定来设计，并不是都要有。
